...
export function datosCita(e: Event ) {
    const target = e.target as HTMLInputElement //HTMLInputElement es una interfaz
...
export function submitCita(e: SubmitEvent) {
    ...
    formulario?.reset()
    reiniciarObjetoCita()
    // tambien puede ser formularioInput ? formularioInput.value = 'Registrar Paciente' : null
